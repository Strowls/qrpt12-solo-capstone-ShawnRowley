...
export class demoBlaze extends BasePage {
    ...
    loginBtn: By = By.xpath('//a[text()= "Log in"]')
    logoutBtn: By = By.css("#logout2")
    loginUser: By = By.css("#loginusername")
    loginPW: By = By.css("#loginpassword")
    loginConfirm: By = By.xpath('//button[text()= "Log in"]')
    nameOfUser: By = By.css("#nameofuser")
